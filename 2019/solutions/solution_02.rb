...
module AOC2019D02
  ...
  def execute_section(intcode, section_start)
    opcode = intcode[section_start]
    position_operand_a = intcode[section_start + 1]
    position_operand_b = intcode[section_start + 2]
